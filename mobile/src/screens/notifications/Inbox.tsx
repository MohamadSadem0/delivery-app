...
import { fetchNotifications, markAllReadThunk } from '@/features/notifications/notificationsSlice';
...
export default function InboxScreen() {
  ...
  return (
    <Screen>
      ...
      <Button title="Mark all as read" variant="outline" onPress={() => dispatch(markAllReadThunk())} />
      <FlatList
        data={items}
